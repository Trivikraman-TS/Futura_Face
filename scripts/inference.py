...
def run():
    ...
    out_path_results = 'inference_results'
    out_path_coupled = 'inference_coupled'
            ...
            with torch.no_grad():
                ...
                for i in range(len(input_batch)):
                    ...
                    if opts.couple_outputs or global_i % 100 == 0:
                        ...
                        print(f"image_name: {os.path.basename(im_path)}")
                        print(f"im_save_path: {os.path.join(age_out_path_coupled, os.path.basename(im_path))}")
                    ...
                    print(f"im_save_path: {im_save_path}")
